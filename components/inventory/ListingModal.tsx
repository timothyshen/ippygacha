            ...
            >
                <CardContent className="p-0">
                    <div className="relative">
                        ...
                        {/* Hover Overlay */}
                        {/* {isHovered && (
                                <div className="absolute inset-0 bg-black/50 flex items-center justify-center gap-4 transition-all duration-300">
                                    <Drawer open={listingOpen} onOpenChange={setListingOpen}>
                                        ...
                                        <DrawerContent className="w-full sm:max-w-2xl bg-gray-900 text-white border-gray-800">
                                            ...
                                            <div className="py-6 space-y-6">
                                                ...
                                                <div className="flex gap-4 pt-4">
                                                    ...
                                                    <Button className="flex-1 bg-blue-600 hover:bg-blue-700">Review listing</Button>
                                                </div>
                                            </div>
                                        </DrawerContent>
                                    </Drawer>
