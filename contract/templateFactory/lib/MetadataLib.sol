...
library MetadataLib {
    ...
    function tokenURI(uint8 nftType, uint256 tokenId) internal pure returns (string memory) {
    ...
    function getNFTTypeName(uint8 nftType) internal pure returns (string memory) {
    ...
    function _attributes(uint8 nftType) private pure returns (string memory) {
        ...
        if (nftType == HIDDEN_NFT_ID) {
            return '{"trait_type":"Tier","value":"Hidden"},{"trait_type":"Affinity","value":"Mystery"},{"trait_type":"Power","value":"Legendary"}';
        }
