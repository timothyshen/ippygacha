...
export const ClawControlPanel = ({
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 p-2 sm:p-4 flex justify-center items-center z-50">
            <div className="flex items-center gap-1 sm:gap-2 md:gap-4 px-3 sm:px-4 md:px-6 py-2 sm:py-3 rounded-xl sm:rounded-2xl border-2 shadow-lg bg-white/80 backdrop-blur-md border-orange-200/50 w-full max-w-sm sm:max-w-md md:max-w-lg">
                {/* Coin Balance */}
                <Button
                    variant="ghost"
                    size="sm"
